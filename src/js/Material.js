/**
 * Clase Material - Representa un material con información de costos e inventario
 */
class Material {
    /**
     ...
     */
    constructor(nombreMaterial, costoPorUnidad, inventario = 0) {
        this.nombreMaterial = this.validarNombre(nombreMaterial);
    ...
    /**
     * Getter para obtener el nombre del material
     * @returns {string} Nombre del material
     */
    getNombreMaterial() {
    ...
    /**
     * Setter para establecer el nombre del material
     * @param {string} nombre - Nuevo nombre del material
     */
    setNombreMaterial(nombre) {
        this.nombreMaterial = this.validarNombre(nombre);
    }
     ...
     * @returns {string} Información del material
     */
    toString() {
        return `Material: ${this.nombreMaterial}
    ...
    /**
     * Devuelve un objeto con toda la información del material
